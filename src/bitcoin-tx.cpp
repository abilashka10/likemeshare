...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s likemeeeshare-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  likemeeeshare-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded likemeeeshare transaction") + "\n" +
              "  likemeeeshare-tx [options] -create [commands]   " + _("Create hex-encoded likemeeeshare transaction") + "\n" +
              "\n";
