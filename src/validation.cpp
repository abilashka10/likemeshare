...
#if defined(NDEBUG)
# error "Likemeeeshare cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Likemeeeshare Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s LMS additional fees, %d delta bytes\n",
