...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/likemeeeshare-project/likemeeeshare>";
    const std::string URL_WEBSITE = "<https://likemeeeshare.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Likemeeeshare version %s\n", FormatFullVersion());
}
