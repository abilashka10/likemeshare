Likemeeeshare Core version *0.15.1* is now available from:

  <https://download.likemeeeshare.org/likemeeeshare-0.15.1/>
...
A number of changes to the way Likemeeeshare Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 products per kB (0.00001 LMS). This is to prepare for dropping the minimum transaction fee to 0.1 products per kB (0.0001 LMS) in the next release.
